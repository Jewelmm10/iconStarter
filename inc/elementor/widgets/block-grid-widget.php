...
class Icon_Block_Grid extends Widget_Base {

    public function get_name() {
        return 'block_grid_widget';
    }

    public function get_title() {
        return __('Icon Block Grid', 'iconstarter');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'cat-label',
            [
                'label' => esc_html__( 'Category Label', 'iconstarter' ),
                'type' => Controls_Manager::SELECT,                
                'options' => [
                    'enabled' => esc_html__( 'Enabled', 'iconstarter' ),
                    'disable' => esc_html__( 'Disabled', 'iconstarter' ),
                ],
                'default'=> 'enabled',
            ]
        );
        ...
        $this->add_control(
            'title-line',
            [
                'label' => esc_html__( 'Limit Title to Lines', 'iconstarter' ),
                'type' => Controls_Manager::SELECT,                
                'options' => [
                    'no-limit'  => esc_html__( 'No Limit', 'iconstarter' ),
                    '1'         => esc_html__( '1', 'iconstarter' ),
                    '2'         => esc_html__( '2', 'iconstarter' ),
                    '3'         => esc_html__( '3', 'iconstarter' ),
                    'default'   => esc_html__( 'Default', 'iconstarter' ),
                ],
                'default'=> 'default',
                'separator' => 'before',
            ]
        ...
        $this->add_control(
            'excerpt_length',
            [
                'label'     => __('Excerpt Words', 'iconstarter'),
                'type'      => Controls_Manager::NUMBER,
                'default'   => 16,
                'condition' => [
                    'excerpt' => 'yes',
        ...
        $this->add_control(
            'icon_show_image',
            [
                'label' => __('Show Media/Image', 'iconstarter'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'iconstarter'),
                'label_off' => __('Hide', 'iconstarter'),
                'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label'   => esc_html__( 'Image Resolution', 'iconstarter' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'full',
				'options' => [
					'full'         => esc_html__( '3:4 Tall', 'iconstarter' ),
					'full'         => esc_html__( '3:4 Tall', 'iconstarter' ),
					'full'         => esc_html__( '3:4 Tall', 'iconstarter' ),
					'full'         => esc_html__( '3:4 Tall', 'iconstarter' ),
					'full'         => esc_html__( '3:4 Tall', 'iconstarter' ),
