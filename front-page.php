...
<section class="cat_news">
    <div class="container">
        <div class="content">
            <div class="trow">
                <div class="trow-gap w-2/3">
                    <!-- news widgets -->
                                            ...
                                            <div class="content my-3">
                                                ...
                                                <div class="author-name flex text-xs my-2">
                                                    ...
                                                    <div class="ml-2 post-comments">
                                                        <i
                                                            class="ri-discuss-fill mr-2"></i><?php echo get_comments_number(); ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="posts">
                                            ...
                                            <div class="post-item">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span
                                                        class="text-xs text-gray-500"><?php echo get_the_date('F j, Y'); ?></span>
                                                </div>
                                            </div>
                                            <?php endwhile; ?>
                                        </div>
                    ...
                    <div class="news-widget">
                        <div class="heading">
                            <h4 class="border-red-500"><span class="bg-red-500">Tech and Gadgets</span></h4>
                        </div>
                        <div class="trow">
                            <div class="trow-gap w-full">
                                <div class="trow">
                ...
                <div class="trow-gap w-1/3">
                    <div class="sticky top-0">
                        <!-- news widgets -->
                        <div class="news-widget">
                            <div class="heading">
                                <h4 class="border-slate-600"><span class="bg-slate-600">Make it modern</span></h4>
                            </div>
                            ...
                            <div class="trow news overflow-hidden">
                                <?php
                                        ...
                                        if ($query->have_posts()) :
                                            while ($query->have_posts()) : $query->the_post();
                                    ?>
                                <div class="trow-gap post-item w-1/2">
                                    <div class="post-thumb relative">
                                        <a href="<?php the_permalink(); ?>">
                                            <?php if (has_post_thumbnail()) : ?>
                                            <?php the_post_thumbnail('large', ['class' => 'attachment-large size-large wp-post-image']); ?>
                                    ...
                                    <div class="content my-3">
                                        <h3>
                                            <a class="title text-sm font-normal" href="<?php the_permalink(); ?>">
                                                <?php the_title(); ?>
                                            </a>
                                        </h3>
                                    </div>
                        ...
                        <div class="news-widget">
                            <div class="heading">
                                <h4 class="border-gray-900"><span class="bg-gray-900">Latest Reviews</span></h4>
                            </div>
                            <div class="trow">
                                <div class="trow-gap w-full">
                                    <div class="trow">
                        ...
                        <div>
                            <div class="text-center text-xs text-gray-400">-Advertisment-</div>
                            <img src="http://localhost/news/wp-content/uploads/2023/10/newspaper-rec300@2x.jpg">
                        </div>
                    </div>
                    <!-- stick -->
            ...
            <div class="trow justify-center my-10">
                <div>
                    <div class="text-center text-xs text-gray-400">Advertisment</div>
                    <img src="<?php echo get_template_directory_uri(); ?>/images/ads.jpg">
                </div>
            </div>
            <div class="trow">
                <div class="trow-gap w-2/3">
                        ...
                        <div class="news">
                            ...
                            <div class="posts">
                                ...
                                <div class="post-item">
                                    ...
                                    <div class="content">
                                        <h3>
                                            <a class="title text-sm" href="<?php the_permalink(); ?>">
                                                <?php the_title(); ?>
                                            </a>
                                        </h3>
