...
class Icon_Featured extends Widget_Base {
    ...
    public function get_title() {
        return __('Icon Featured Grid', 'iconstarter');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 1,
                'selectors'  => [
                    '{{WRAPPER}} .icon-thumb' => 'aspect-ratio: {{SIZE}};',
                ],
                'condition' => [
                    'has_ratio' => 'yes'
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .icon-thumb' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'has_ratio!' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .cat_name' => 'height: {{SIZE}}{{UNIT}};',
                ],
			],
        );
        $this->add_control(
